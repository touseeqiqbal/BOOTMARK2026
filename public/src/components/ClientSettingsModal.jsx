...
import { X, Save, Users, Hash, MapPin } from 'lucide-react';
import api from '../utils/api';

export default function ClientSettingsModal({ show, onClose, onSave }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setSaving(true);
            await api.put('/customers/settings', settings);
                ...
                {loading ? (
                    ...
                    <form onSubmit={handleSubmit}>
                        <div style={{ background: '#f9fafb', padding: '16px', borderRadius: '8px', marginBottom: '20px', border: '1px solid #e5e7eb' }}>
                            ...
                            <div className="form-group">
                                <label style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                    <Hash size={14} /> Next Client Number
                                </label>
                                <input
                                    type="number"
                                ...
                                />
                                <small style={{ color: '#6b7280', display: 'block', marginTop: '4px' }}>Used when auto-generating client IDs</small>
                            </div>
                        </div>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <small style={{ color: '#6b7280', display: 'block', marginTop: '4px' }}>These values will be pre-filled when creating a new client.</small>
                        </div>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <div className="form-group">
                                ...
                                <small style={{ color: '#6b7280', display: 'block', marginTop: '4px' }}>Preferred layout when opening the clients page.</small>
                            </div>
                        </div>
