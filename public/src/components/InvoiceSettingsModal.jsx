...
import { X, Save, FileText, Hash, DollarSign, Percent } from 'lucide-react';
import api from '../utils/api';

export default function InvoiceSettingsModal({ show, onClose, onSave }) {
    ...
    const fetchSettings = async () => {
        try {
            setLoading(true);
            // This endpoint was just added to the backend
            ...
            // Don't show alert for 404 on first load, just use defaults
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setSaving(true);
            await api.put('/invoices/settings', settings);
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea
                                    ...
                                    placeholder="Enter terms that should appear on every new invoice..."
                                />
                            </div>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <div className="form-group">
                                ...
                                <small style={{ color: '#6b7280', display: 'block', marginTop: '4px' }}>Preferred layout when opening the invoices page.</small>
                            </div>
                        </div>
