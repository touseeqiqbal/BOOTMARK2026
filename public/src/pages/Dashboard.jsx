...
export default function Forms() {
  ...
  const createForm = async () => {
    try {
      ...
      navigate(`/${user?.currentBusiness?.slug}/form/${response.data.id}`)
    } catch (error) {
                ...
                {forms.map(form => {
                  ...
                  return (
                    <div
                      key={form.id}
                      className="form-card"
                      onClick={() => navigate(`/${user?.currentBusiness?.slug}/form/${form.id}`)}
                    ...
                    >
                      ...
                      <div className="form-card-footer">
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            navigate(`/${user?.currentBusiness?.slug}/form/${form.id}/entry`)
                          }}
                        >
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            navigate(`/${user?.currentBusiness?.slug}/form/${form.id}/submissions`)
                          }}
                        >
                          Submissions
                        </button>
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            navigate(`/${user?.currentBusiness?.slug}/form/${form.id}/table`)
                          }}
                        >
                          <Table size={14} />
                          Table
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            navigate(`/${user?.currentBusiness?.slug}/form/${form.id}/reports`)
                          }}
                        >
                          <BarChart size={14} />
                          Reports
